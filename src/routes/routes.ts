...
//import _expressAuthentication  from './../Auth/auth';
    ...
    // ###########################################################################################################
        ...
        app.post('/user/login',
            ...
            const args = {
                    ...
                    res: {"in":"body","name":"res","required":true,"dataType":"any"},
            };
        ...
        app.post('/user/signin',
            ...
            function UserController_signIn(request: any, response: any, next: any) {
            const args = {
                    req: {"in":"request","name":"req","required":true,"dataType":"object"},
                    res: {"in":"body","name":"res","required":true,"dataType":"any"},
            };
        ...
        app.post('/user/signOut',
            ...(fetchMiddlewares<RequestHandler>(UserController)),
            ...(fetchMiddlewares<RequestHandler>(UserController.prototype.signOut)),

            function UserController_signOut(request: any, response: any, next: any) {
            const args = {
                    req: {"in":"request","name":"req","required":true,"dataType":"object"},
                    res: {"in":"body","name":"res","required":true,"dataType":"any"},
            };
