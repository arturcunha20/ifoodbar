...
let ProdutsTypeController = class ProdutsTypeController extends tsoa_1.Controller {
    /**
    ...
    create(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (data) {
                    const result = yield new ProductsTypeService_1.ProductsTypeService().create(name);
                    if (result)
                        res.status(200).send({ status: "Success", message: "Product Type created", data: result });
                    else
   ...
   */
    getAll(res) {
        return __awaiter(this, void 0, void 0, function* () {
            const data = yield new ProductsTypeService_1.ProductsTypeService().getProductsType();
            if (data.length > 0) {
